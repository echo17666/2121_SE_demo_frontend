  ...
  <div class="container my-auto" >
    <div class="my-auto" width="80vw">
      <div>
        ...
        <div>
          <div class="row col-md-12 m-auto" :style="{'margin':0}">
            <div class="col-md-5">
              <v-form>
                <v-text-field
                ...
                <v-alert dense outlined type="error" v-show="registerForm.errors"
                  >{{ registerForm.usernameError|| registerForm.emailError||registerForm.passwordError|| registerForm.password2Error|| registerForm.idcodeError}}
                  </v-alert>
                <v-card-actions>
                   <!-- <v-card-actions>
                  <v-btn class="info" @click="getIDCode">获取验证码</v-btn>
                </v-card-actions> -->
                  <v-btn class="info" v-show="this.showIDCode" @click="getIDCode()"
                    >注册</v-btn
                  >
                </v-card-actions>
              </v-form>
...
import { Account } from "../../axios/account.js";
export default {
  name: "Register",
   components: {
  },
